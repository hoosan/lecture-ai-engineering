...
page = st.sidebar.radio(
    "ページ選択",
    ["チャット", "履歴閲覧", "サンプルデータ管理", "ダッシュボード"],
    key="page_selector",
    index=["チャット", "履歴閲覧", "サンプルデータ管理", "ダッシュボード"].index(st.session_state.page), # 現在のページを選択状態にする
...
elif st.session_state.page == "ダッシュボード":
    ui.display_dashboard_page()
